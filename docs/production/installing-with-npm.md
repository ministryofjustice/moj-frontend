...
In your live application, we recommend [using an automated task or your build pipeline](/production/import-font-and-image-assets/) instead of copying the files manually.
...
- [using an automated task or your build pipeline](/production/setting-up-javascript/) instead of copying the files manually
- importing only the components your application uses and [initialising all their instances](/production/setting-up-javascript/#initialise-individual-components) on the page
