...
{% set figmaTabContent = '<p>Use this component from the ‘Assets’ tab in the PDS Figma Kit.</p><p>You can also view this component in the <a href="{{ figma_link }}" target="_blank">PDS Figma Kit (opens in a new tab).</a></p>' %}
