...
* it follows the convention established by the abbreviation of [ROTL for release on temporary licence](#rotl-release-on-temporary-licence) and so helps to improve consistency
