...
---
A Figma design has been added for this component. There may be more links and resources in the [‘confirm an action’ Github discussion]({{ githuburl }}).


### Figma

If you work for MOJ, [View the ‘confirm an action’ component in the MOJ Figma Kit]({{figma_link}}).
