...
There may be more information in the [‘pr two-four-seven-four’ Github discussion]({{ githuburl }}). You can also view the component image in the overview.
