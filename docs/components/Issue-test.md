...
<div class="img-container">
  <img src="/assets/images/submission-1756877854711/Screenshot-2025-04-02-at-22.59.16.png" alt="Issue test" />
</div>
...
You can help develop this component by adding information to the [Issue test Github discussion]({{ githuburl }}). This helps other people to use it in their service.
...
A Figma design has been added for this component. There may be more links and resources in the [Issue test Github discussion]({{ githuburl }}).


### Figma

      [View the Issue test component in the MoJ Figma Kit (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [Issue test Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [Issue test Github discussion]({{ githuburl }}).
