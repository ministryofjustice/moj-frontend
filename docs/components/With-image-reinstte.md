...
<div class="img-container">
  <img src="/assets/images/submission-1756302675573/Screenshot-2025-04-02-at-14.53.39.png" alt="With image reinstte" />
</div>
...
You can help develop this component by adding information to the [With image reinstte Github discussion]({{ githuburl }}). This helps other people to use it in their service.
...
A Figma link has been added for this component. There may be more links and resources in the [With image reinstte Github discussion]({{ githuburl }}).


### Figma link

      [View the With-image-reinstte in Figma (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [With image reinstte Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [With image reinstte Github discussion]({{ githuburl }}).
