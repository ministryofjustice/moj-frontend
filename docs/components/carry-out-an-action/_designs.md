...
---
A Figma design has been added for this component. There may be more links and resources in the [‘carry out an action’ Github discussion]({{ githuburl }}).


### Figma

If you work for MOJ, [View the ‘carry out an action’ component in the MOJ Figma Kit]({{figma_link}}).
