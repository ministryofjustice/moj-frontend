...
title: Designs
order: 20
tags: 'laa-header-and-navigation'
permalink: false
eleventyComputed:
  override:eleventyNavigation: false
---
A Figma design has been added for this component. There may be more links and resources in the [‘laa header and navigation’ Github discussion]({{ githuburl }}).


### Figma

If you work for MOJ, [View the ‘laa header and navigation’ component in the MOJ Figma Kit]({{figma_link}}).
