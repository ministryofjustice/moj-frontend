...
- the 2 GOV.UK buttons for the stacked layout (but not the magnifying glass icon)
...
It's always preferrable to use a visible label or hint text. 
...
- at the top of the page (for site search), like in the [primary navigation component](/components/primary-navigation/)

Do not add the component to the [MOJ header](/components/moj-header/). There isn’t space in the header, and doing this would make the component's use inconsistent.
