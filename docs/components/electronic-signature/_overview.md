...
## Overview
The electronic signature pattern allows users to legally sign a document or instrument electronically online.
...
You can help develop this component by adding information to the [‘electronic signature’ Github discussion]({{ githuburl }}). This helps other people to use it in their service.