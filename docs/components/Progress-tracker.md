...
<div class="img-container">
  <img src="/assets/images/submission-1755767844876/hello.png" alt="Progress tar" />
</div>
...
A Figma link has been added for this component. There may be more links and resources in the [Progress-tar Github discussion]({{ githuburl }}).


### Figma link

      [View the Progress-tar in Figma (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [Progress-tar Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [Progress-tar Github discussion]({{ githuburl }}).
