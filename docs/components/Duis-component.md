...
<div class="img-container">
  <img src="/assets/images/submission-1756360201675/Screenshot-2025-04-02-at-22.59.16.png" alt="Duis component" />
</div>
...
You can help develop this component by adding information to the [Duis component Github discussion]({{ githuburl }}). This helps other people to use it in their service.
...
A Figma link has been added for this component. There may be more links and resources in the [Duis component Github discussion]({{ githuburl }}).


### Figma link

      [View the Duis-component in Figma (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [Duis component Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [Duis component Github discussion]({{ githuburl }}).
