...
<div class="img-container">
  <img src="/assets/images/submission-1755530907379/Screenshot-2025-04-17-at-13.08.09.png" alt="new base" />
</div>
...
A Figma link has been added for this component. There may be more links and resources in the [New-base Github discussion]({{ githuburl }}).


### Figma link

      [View the New-base in Figma (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [New-base Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [New-base Github discussion]({{ githuburl }}).
