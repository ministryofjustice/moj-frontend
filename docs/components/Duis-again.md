...
<div class="img-container">
  <img src="/assets/images/submission-1755547997300/Screenshot-2025-07-08-at-14.39.18.png" alt="Duis again" />
</div>
...
A Figma link has been added for this component. There may be more links and resources in the [Duis-again Github discussion]({{ githuburl }}).


### Figma link

      [View the Duis-again in Figma (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [Duis-again Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [Duis-again Github discussion]({{ githuburl }}).
