...
contributorName: legend me
contributorTeam: shakespeare
---
...
<div class="img-container">
  <img src="/assets/images/submission-1754662553101/2Wg9fMv__400x400.jpg" alt="x" />
</div>
...
A Figma link was not included when this component was added.
      ...
      There may be more information in the [X Github discussion]({{ githuburl }}). You can also view the component image in the overview.
...
Accessibility findings have been added for this component. There may be more findings in the [X Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [X Github discussion]({{ githuburl }}).
...
```html
{% raw %}
<div class="moj-alert moj-alert--information moj-alert--with-heading">
  <div>
  ...
  <div class="moj-alert__content">
    <h2 class="moj-alert__heading">The finance section has moved
    </h2>You can now find it in the <a href="#">dashboard</a>.
  </div>

  <div class="moj-alert__action">
    <button class="moj-alert__dismiss">Dismiss</button>
  </div>
</div>

<div class="moj-alert moj-alert--success moj-alert--with-heading">
  <div>
  ...
  <div class="moj-alert__content">
    <h2 class="moj-alert__heading">File uploaded successfully
...
<div class="moj-alert moj-alert--warning moj-alert--with-heading">
  <div>
  ...
  <div class="moj-alert__content">
    <h2 class="moj-alert__heading">Some information could not be imported
...
<div class="moj-alert moj-alert--error moj-alert--with-heading">
  <div>
  ...
  <div class="moj-alert__content">
    <h2 class="moj-alert__heading">This case has been assigned to someone else
