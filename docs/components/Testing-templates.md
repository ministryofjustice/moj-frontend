...
<div class="img-container">
  <img src="/assets/images/submission-1756888754847/Screenshot-2025-04-02-at-22.59.16.png" alt="Testing templates" />
</div>
...
You can help develop this component by adding information to the [Testing templates Github discussion]({{ githuburl }}). This helps other people to use it in their service.
...
A Figma design has been added for this component. There may be more links and resources in the [Testing templates Github discussion]({{ githuburl }}).


### Figma

      [View the Testing templates component in the MoJ Figma Kit (opens in a new tab)]()
...
Accessibility findings have been added for this component. There may be more findings in the [Testing templates Github discussion]({{ githuburl }}).
...
Code has been added for this component. There may be other code blocks in the [Testing templates Github discussion]({{ githuburl }}).
