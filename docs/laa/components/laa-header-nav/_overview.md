...
The 'LAA header and navigation' component helps users to understand that they're using a service from the Legal Aid Agency. 

It has 5 parts:

- the LAA header
- the [GOV.UK service navigation component](https://design-system.service.gov.uk/components/service-navigation/)
- the [GOV.UK phase banner component](https://design-system.service.gov.uk/components/phase-banner/)
