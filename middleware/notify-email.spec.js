...
describe('sendEmail', () => {
  ...
  it('should send an email successfully', async () => {
    ...
    expect(mockSendEmail).toHaveBeenCalledWith(expect.any(String), expect.any(String), {
  ...
  it('should handle errors when sending an email', async () => {
    ...
    await expect(sendEmail('http://example.com')).rejects.toThrow('Failed to send email');
