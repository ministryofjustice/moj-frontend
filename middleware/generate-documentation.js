const generateMarkdown = (data) => {
  const {
    ...
    '/get-involved/add-new-component/accessibility-findings': accessibilityFindings,
    '/get-involved/add-new-component/accessibility-findings-more': accessibilityFindingsMore,
    ...
    '/get-involved/add-new-component/component-code-details': componentCodeDetails,
    '/get-involved/add-new-component/component-image': imageData,
    '/get-involved/add-new-component/additional-information': additionalInformation,
