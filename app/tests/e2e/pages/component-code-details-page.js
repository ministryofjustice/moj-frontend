...
export class ComponentCodeDetailsPage extends ContributionsPage {
  constructor(page) {
    ...
    this.usageInput = this.page.getByLabel(
      'How do you use the code? (optional)'
    )
    this.otherLanguageInput = this.page.getByLabel('Enter the code language')
    this.addAnotherButton = this.page.getByRole('button', {
      name: 'Add another code block'
    })

    this.countMessages = this.page.locator(
