...
export class AccessibilityFindingsPage extends ContributionsPage {
  constructor(page) {
    ...
    this.externalAuditFieldset = page.getByRole('group', {
      name: 'Has the component been tested in an external accessibility audit?'
    })
    this.internalReviewFieldset = page.getByRole('group', {
      name: 'Has the component been reviewed internally?'
    })
    this.assistiveTechFieldset = page.getByRole('group', {
      name: 'Has the component been tested with assistive technology?'
    })
  }
