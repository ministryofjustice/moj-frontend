...
function createComponent(params = {}) {
  ...
  const html =
    params.html ??
    outdent`
      <div role="${role}" class="moj-alert moj-alert--information moj-alert--with-heading" aria-label="information: The finance section has moved" data-module="moj-alert"${attributes}>
        <div>
